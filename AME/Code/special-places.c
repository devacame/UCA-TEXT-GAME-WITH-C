		...
		switch(cmd){
			...
			case 18:
				if(money(3,0) >= 4000){
					...
					puts("돈, 없으면서 뭘 사려고? 4000G 이상은 있어야지 어?!");
				}
				break;
		}
	}
